   ...
   <AuthenticatedLayout>
      ...
      <div class="py-12">
         <div class=" max-w-7xl mx-auto sm:px-6 lg:px-8 mb-8">
            <div v-if="props.permissions.data.length" class="flex flex-col">
               <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                  <div class="flex bg-gray-800 justify-between items=center p-5">
                     <div class="flex space-x-2 items-center text-white">
                        Permissions Available in the Database
                     </div>
                     <div class="flex space-x-2 items-center" v-if="can.create">
                        ...
                        <span class="iconify mr-1" data-icon="gridicons:create" data-inline="false"></span> Add new
                        Permission
                        </Link>
                     </div>
                  </div>
                        ...
                        <tr v-for="permission in permissions.data" :key="permission.id"
                           ...
                           <td v-if="can.edit || can.delete" class="py-4 px-6 w-48">
                              <div type="justify-start lg:justify-end" no-wrap>
                                 ...
                                 <BreezeButton @click="destroy(permission.id)"
            ...
            <div v-else class=" text-center bg-gray-100 shadow-none rounded-none">
               <p class="text-3xl font-normal text-red-600"> No any Permission at the moment!!!!!
                  <span class="bg-gray-300 px-2 py-1 rounded-lg mx-3 hover:bg-gray-400 cursor-pointer text-black">
                     <Link :href="route('permissions.create')">Create new permission from here</Link>
                  </span>
               </p>
            </div>
         </div>
